  ...
  try {
    if (fs.existsSync(DATA_FILE)) {
      ...
      return {
        ...
        cargo: (data.cargo && data.cargo.length > 0) ? data.cargo : defaultSeed.cargo,
        sorties: (data.sorties && data.sorties.length > 0) ? data.sorties : defaultSeed.sorties,
        lifeSupport: data.lifeSupport || defaultSeed.lifeSupport,
        permits: (data.permits && data.permits.length > 0) ? data.permits : defaultSeed.permits,
        wasteRecords: (data.wasteRecords && data.wasteRecords.length > 0) ? data.wasteRecords : defaultSeed.wasteRecords,
        emergencies: (data.emergencies && data.emergencies.length > 0) ? data.emergencies : defaultSeed.emergencies,
...
// -------------------------------------------------------------
// 1. HEALTH, STATE & COMPLIANCE ENDPOINTS
// -------------------------------------------------------------
